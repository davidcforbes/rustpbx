...
impl CallController {
    ...
    ///
    /// NOTE: Full integration with SessionAction::StartRecording is pending.
    /// The controller currently sends a PlayPrompt as a beep placeholder
    /// and returns a handle. The proxy layer integration will be completed
    ...
    pub async fn start_recording(
        ...
        let p = path.into();
        // TODO: Once SessionAction::StartRecording is added to the proxy layer,
        // send the proper command here:
